...
def buscar_participante_3 (array_nombre : list, lista : float, lista_puntajes : list):
    """busca promedio de puntaje y muestra de quien es

    Args:
        array_nombre (list): lista con nombres/datos str
        mayores(list): promedio de puntajes de cada párticipante
    Returns:
    ...
    for j in range(len(lista_puntajes)):
        if lista == lista_puntajes[j]:
            lista  = lista_puntajes[j]
            nombre =  array_nombre[j]
            print(f"{nombre}\nPromedio puntaje: {lista}")
            print("")
        else:
            continue
...
def mostrar_part_mayor_prom(array_nombre : list, array_notas_jurados : list):
    ...
    buscar_participante_3(array_nombre,mayores[0],lista_puntajes)
    buscar_participante_3(array_nombre,mayores[1],lista_puntajes)
    buscar_participante_3(array_nombre,mayores[2],lista_puntajes)
